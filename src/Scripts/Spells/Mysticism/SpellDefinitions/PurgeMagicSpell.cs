...
public class PurgeMagicSpell : MysticSpell
{
	...
	private static BuffType GetRandomBuff(Mobile target)
	{
		List<BuffType> buffs = new();
	...
	private static void RemoveImmunity(Mobile from)
	{
	...
	private static void RemoveCurse(Mobile from, Mobile caster)
	{
	...
	{
		private PurgeMagicSpell Owner { get; }

		public InternalTarget(PurgeMagicSpell owner, bool allowland = false)
