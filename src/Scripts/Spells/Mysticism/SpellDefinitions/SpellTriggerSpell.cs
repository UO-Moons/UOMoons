...
public class SpellTriggerSpell : MysticSpell
{
	...
	private class SpellTriggerGump : Gump
	{
		...
		public override void OnResponse(NetState sender, RelayInfo info)
		{
			...
			if (from.Backpack != null && info.ButtonID is >= 100 and <= 110 && m_Spell.CheckSequence())
			{
	...
	private static readonly SpellTriggerDef[] m_Definitions = {
		new( 677, "Nether Bolt",        1, 1031678, 1095193, 0x2D9E ),
		new( 678, "Healing Stone",      1, 1031679, 1095194, 0x2D9F ),
		new( 679, "Purge Magic",        2, 1031680, 1095195, 0x2DA0 ),
		new( 680, "Enchant",            2, 1031681, 1095196, 0x2DA1 ),
		new( 681, "Sleep",              3, 1031682, 1095197, 0x2DA2 ),
		new( 682, "Eagle Strike",       3, 1031683, 1095198, 0x2DA3 ),
		new( 683, "Animated Weapon",    4, 1031684, 1095199, 0x2DA4 ),
		new( 684, "Stone Form",         4, 1031685, 1095200, 0x2DA5 ),
		new( 686, "Mass Sleep",         5, 1031687, 1095202, 0x2DA7 ),
		new( 687, "Cleansing Winds",    6, 1031688, 1095203, 0x2DA8 ),
		new( 688, "Bombard",            6, 1031689, 1095204, 0x2DA9 )
	};
