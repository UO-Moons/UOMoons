...
public class SacredJourneySpell : PaladinSpell
{
	...
	public SacredJourneySpell(Mobile caster, Item scroll, RunebookEntry entry = null, Runebook book = null)
	...
	public void Effect(Point3D loc, Map map, bool checkMulti, bool isboatkey = false)
	{
		...
		else if (SpellHelper.RestrictTravelCombat && Caster.Murderer && map.Rules != ZoneRules.FeluccaRules)
		{
