...
public class LightningSpell : MagerySpell
{
	...
	public void Target(IDamageable m)
	{
		...
		else if (CheckHSequence(m))
		{
			...
			Effects.SendBoltEffect(
				m is Mobile ? m : EffectMobile.Create(m.Location, m.Map, EffectMobile.DefaultDuration), true, 0, false);
	...
	{
		private readonly LightningSpell _owner;
