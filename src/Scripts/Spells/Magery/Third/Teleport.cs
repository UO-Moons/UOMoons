...
public class TeleportSpell : MagerySpell
{
	...
	public void Target(IPoint3D p)
	{
		...
		else if (CheckSequence())
		{
			...
			{
				if (item is ParalyzeFieldSpell.InternalItem || item is PoisonFieldSpell.InternalItem || item is FireFieldSpell.FireFieldItem)
					item.OnMoveOver(m);
			}
	...
	{
		private readonly TeleportSpell _owner;
