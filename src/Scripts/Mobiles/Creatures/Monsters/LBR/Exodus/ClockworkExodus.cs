...
namespace Server.Mobiles
{
    ...
    public sealed class ClockworkExodus : BaseCreature
    {
	    [CommandProperty(AccessLevel.GameMaster)]
        public static int MinHits { get; private set; }

        public static List<ClockworkExodus> Instances { get; private set; }
        ...
        private static void DistributeRandomArtifact(BaseCreature bc, Type[] typelist)
        {
        ...
        private static void DistributeArtifact(Mobile to, Item artifact)
        {
            if (to != null)
            {
        ...
        public double ChangeCombatant => 0.3;
        ...
        private void SpawnVortices(Mobile target)
        {
            Map map = Map;
        ...
        private void DoSpecialAbility(Mobile target)
        {
            if (target != null)
            {
        ...
        public override void OnDamage(int amount, Mobile from, bool willKill)
        {
            ...
            if (Hits < MinHits && Hits < HitsMax * 0.60)
                MinHits = Hits;
