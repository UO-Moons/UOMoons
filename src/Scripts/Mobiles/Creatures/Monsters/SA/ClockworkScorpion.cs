...
public class ClockworkScorpion : BaseCreature, IRepairableMobile
{
	...
	{
		return !Controlled ? 542 : base.GetIdleSound();
	}

	public override int GetDeathSound()
	{
		return !Controlled ? 545 : base.GetDeathSound();
	}
	...
	{
		return Controlled ? 320 : base.GetHurtSound();
	}
	...
	public override void OnDamage(int amount, Mobile from, bool willKill)
	{
		...
		if (master is { Player: true } && master.Map == Map && master.InRange(Location, 20))
		{
