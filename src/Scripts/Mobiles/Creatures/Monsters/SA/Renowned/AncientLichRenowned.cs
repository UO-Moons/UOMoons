...
public class AncientLichRenowned : BaseRenowned
{
	...
	protected override Type[] UniqueSaList => new[] { typeof(SpinedBloodwormBracers), typeof(DefenderOfTheMagus) };
	protected override Type[] SharedSaList => new[] { typeof(SummonersKilt) };
