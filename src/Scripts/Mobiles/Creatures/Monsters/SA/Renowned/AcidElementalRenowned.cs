...
public class AcidElementalRenowned : BaseRenowned
{
	...
	protected override Type[] UniqueSaList => new[] { typeof(BreastplateOfTheBerserker), typeof(TerathanWarriorCostume) };
	protected override Type[] SharedSaList => new[] { typeof(MysticsGarb) };
