...
public class PixieRenowned : BaseRenowned
{
	...
	protected override Type[] UniqueSaList => new[] { typeof(DemonHuntersStandard), typeof(DragonJadeEarrings) };
	protected override Type[] SharedSaList => new[] { typeof(PillarOfStrength), typeof(SwordOfShatteredHopes) };
