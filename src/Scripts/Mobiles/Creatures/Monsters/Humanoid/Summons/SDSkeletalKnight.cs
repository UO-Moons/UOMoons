...
{
	public class SDSkeletalKnight : BaseSummoned
	{
		[Constructable]
		public SDSkeletalKnight() : base( AIType.AI_Melee, FightMode.Closest, 10, 1, 0.2, 0.4 )
		{
		...
		public SDSkeletalKnight( Serial serial ) : base( serial )
		{
		}
