...
{
	public class SDBoneKnight : BaseSummoned
	{
		[Constructable]
		public SDBoneKnight() : base( AIType.AI_Melee, FightMode.Closest, 10, 1, 0.2, 0.4 )
		{
			Name = "a bone knight";
			Body = 57;
			BaseSoundID = 451;
		...
		public SDBoneKnight( Serial serial ) : base( serial )
		{
		}
