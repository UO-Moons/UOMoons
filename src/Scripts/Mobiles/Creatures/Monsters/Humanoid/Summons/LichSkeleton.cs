...
{
	public class LichSkeleton : BaseSummoned
	{
		[Constructable]
		public LichSkeleton() : base( AIType.AI_Melee, FightMode.Closest, 10, 1, 0.2, 0.4 )
		{
			Name = "a skeleton";
			Body = 50;
			BaseSoundId = 0x48D;
		...
		public LichSkeleton( Serial serial ) : base( serial )
		{
		}
