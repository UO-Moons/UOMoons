...
namespace Server.Mobiles
{
    public class ScalisAI : BaseAI
	{
        ...
        public Mobile Animated { get; set; }
                ...
                case 12: // Animate dead
                    {
                        ...
                        if ((Animated == null || !Animated.Alive) && m_Mobile.Skills[SkillName.Necromancy].Value > 40)
                        {
        ...
        public override bool DoActionCombat()
        {
            ...
            if (!m_Mobile.Controlled && !m_Mobile.Summoned && !m_Mobile.IsParagon && m_Mobile.CanFlee)
            {
