...
namespace Server.Mobiles
{
	...
	{
		protected const double HealChance = 0.10; // 25% chance to heal at gm skill
		...
		public virtual Spell GetRandomDamageSpell()
		{
            ...
            else
            {
                ...
                //if (m_Mobile is IceDragon && m_Mobile.Mana >= 200)
                //{
                //
                //    return new IceBreathSpell(m_Mobile, null);
                //}
                //else
                //{
