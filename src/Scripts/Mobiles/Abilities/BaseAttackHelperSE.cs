...
namespace Server
{
    ...
    {
        public static readonly Hashtable m_FanDancerRMT = new();
        public static readonly Hashtable m_RuneBeetleRMT = new();
        public static readonly Hashtable m_HiryuRMT = new();
        public static readonly Hashtable m_KazeKemonoRMT = new();
        public static readonly Hashtable m_RageTable = new();
