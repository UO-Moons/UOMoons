...
public abstract class BaseMobile : Mobile
{
	public static readonly TimeSpan CombatHeatDelay = TimeSpan.FromSeconds(30.0);
...
{
	public Mobile Pet { get; }

	public PetWindow(PlayerMobile owner, Mobile pet)
		: base(0x31)
	{
		Pet = pet;
		var count = owner.AllFollowers.Count;
		...
		for (var i = 0; i < owner.AllFollowers.Count; i++)
		{
