namespace Server.Misc
{
	public class MapDefinitions
	{
		public static void Configure()
		{
			...
			RegisterMap(0, 0, 0, 7168, 4096, 4, "Felucca", ZoneRules.FeluccaRules);
			RegisterMap(1, 1, 1, 7168, 4096, 0, "Trammel", ZoneRules.TrammelRules);
			RegisterMap(2, 2, 2, 2304, 1600, 1, "Ilshenar", ZoneRules.TrammelRules);
			RegisterMap(3, 3, 3, 2560, 2048, 1, "Malas", ZoneRules.TrammelRules);
			RegisterMap(4, 4, 4, 1448, 1448, 1, "Tokuno", ZoneRules.TrammelRules);
			RegisterMap(5, 5, 5, 1280, 4096, 1, "TerMur", ZoneRules.TrammelRules);

			RegisterMap(0x7F, 0x7F, 0x7F, Map.SectorSize, Map.SectorSize, 1, "Internal", ZoneRules.Internal);
