...
namespace Server.Commands
{
    public static class History
    {
        ...
        {
            public static bool Enabled = false;// Is this command enabled?
			public static bool AutoRefreshEnabled = false; // Is the auto refresh enabled?
        ...
        {
            if (m is PlayerMobile pm && pm.HasGump(typeof(HistoryAutoRefreshGump)))
            {
                pm.CloseGump(typeof(HistoryAutoRefreshGump));
        ...
        {
            public virtual string Title => "History - Auto Refresh: OFF";
        ...
        {
            public override string Title => "History - Auto Refresh: ON";
