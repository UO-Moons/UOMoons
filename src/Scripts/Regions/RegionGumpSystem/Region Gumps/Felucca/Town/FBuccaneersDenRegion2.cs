...
{
	public class FBuccaneersDenRegion2 : Gump
	{
		public FBuccaneersDenRegion2( int i )
			: base( 0, 0 )
		{
			...
			foreach (Mobile playerMobile in playerMobiles)
				...
				if( playerregion.Name == "BuccaneersDen" )
					++mobs;
			...
			this.AddLabel(357, 187, 33, @"Players in Region: "+ mobs);
		}
