...
public class AlexandrettasBowlRegion2 : Gump
{
	public AlexandrettasBowlRegion2( int i )
		: base( 0, 0 )
	{
		...
		foreach (Mobile playerMobile in playerMobiles)
		{
			...
			if( playerregion.Name == "Alexandretta's Bowl" )
				++mobs;
		...
		AddLabel(357, 187, 47, @"Players in Region: "+ mobs);
	}
