...
public class PigmentsOfTokuno : BasePigmentsOfTokuno
{
	...
	[Constructable]
	public PigmentsOfTokuno(PigmentType type) : this(type, type is PigmentType.None or >= PigmentType.FadedCoal ? 10 : 50)
	{
	}
	...
	public override void Deserialize(GenericReader reader)
	{
		...
		Type = version switch
		{
			0 => (PigmentType) reader.ReadEncodedInt(),
			_ => Type
		};
	}
}
