...
public class ChampionSpawnInfo
{
	...
	public static ChampionSpawnInfo[] Table { get; } = {
		new( "Abyss", typeof( Semidar ), new[]{ "Foe", "Assassin", "Conqueror" }, new[] // Abyss
		{																											// Abyss
		...
		new( "Arachnid", typeof( Mephitis ), new[]{ "Bane", "Killer", "Vanquisher" }, new[] // Arachnid
		{																											// Arachnid
		...
		new( "Cold Blood", typeof( Rikktor ), new[]{ "Blight", "Slayer", "Destroyer" }, new[] // Cold Blood
		{																											// Cold Blood
		...
		new( "Forest Lord", typeof( LordOaks ), new[]{ "Enemy", "Curse", "Slaughterer" }, new[] // Forest Lord
		{																											// Forest Lord
		...
		new( "Vermin Horde", typeof( Barracoon ), new[]{ "Adversary", "Subjugator", "Eradicator" }, new[] // Vermin Horde
		{																											// Vermin Horde
		...
		new( "Unholy Terror", typeof( Neira ), new[]{ "Scourge", "Punisher", "Nemesis" }, new[] // Unholy Terror
		{																											// Unholy Terror
			Core.AOS ?
		...
		{																											// Glade
			...
			new[]{ typeof( FerelTreefellow ), typeof( RagingGrizzlyBear ) }
		} ),
