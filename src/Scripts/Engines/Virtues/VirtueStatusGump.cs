...
public class VirtueStatusGump : Gump
{
	...
	public override void OnResponse(NetState state, RelayInfo info)
	{
		switch (info.ButtonID)
		{
			case 1:
			{
				_beholder.SendGump(new VirtueInfoGump(_beholder, VirtueName.Humility, 1052051));
				break;
			}
			case 2:
			{
				_beholder.SendGump(new VirtueInfoGump(_beholder, VirtueName.Sacrifice, 1052053, @"http://update.uo.com/design_389.html"));
				break;
			}
			case 3:
			{
				_beholder.SendGump(new VirtueInfoGump(_beholder, VirtueName.Compassion, 1053000, @"http://update.uo.com/design_412.html"));
				break;
			}
			case 4:
			{
				_beholder.SendGump(new VirtueInfoGump(_beholder, VirtueName.Spirituality, 1052056));
				break;
			}
			case 5:
			{
				_beholder.SendGump(new VirtueInfoGump(_beholder, VirtueName.Valor, 1054033, @"http://update.uo.com/design_427.html"));
				break;
			}
			case 6:
			{
				_beholder.SendGump(new VirtueInfoGump(_beholder, VirtueName.Honor, 1052058, @"http://guide.uo.com/virtues_2.html"));
				break;
			}
			case 7:
			{
				_beholder.SendGump(new VirtueInfoGump(_beholder, VirtueName.Justice, 1052059, @"http://update.uo.com/design_413.html"));
				break;
			}
			case 8:
			{
				_beholder.SendGump(new VirtueInfoGump(_beholder, VirtueName.Honesty, 1052060));
				break;
			}
			case 9:
			{
