...
public class SacrificeVirtue
{
	...
	{
		return (m is not BaseCreature creature || (!creature.Controlled && !creature.Summoned)) && m is Lich or Succubus or Daemon or EvilMage or EnslavedGargoyle or GargoyleEnforcer;
	}
