...
namespace Server.Guilds
{
	...
	public class GuildDiplomacyGump : BaseGuildListGump<Guild>
	{
		...
		public GuildDiplomacyGump(PlayerMobile pm, Guild g)
			: this(pm, g, GuildDiplomacyGump.NameComparer.Instance, true, "", 0, GuildDisplayType.All, Utility.CastConvertList<BaseGuild, Guild>(new List<BaseGuild>(World.Guilds.Values)), (1063136 + (int)GuildDisplayType.All))
		{
		}
		...
		public GuildDiplomacyGump(PlayerMobile pm, Guild g, IComparer<Guild> currentComparer, bool ascending, string filter, int startNumber, GuildDisplayType display)
			: this(pm, g, currentComparer, ascending, filter, startNumber, display, Utility.CastConvertList<BaseGuild, Guild>(new List<BaseGuild>(World.Guilds.Values)), (1063136 + (int)display))
		{
		}
