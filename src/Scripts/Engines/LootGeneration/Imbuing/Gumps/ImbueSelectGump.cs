...
namespace Server.Gumps
{
    public class ImbueSelectGump : BaseGump
    {
        ...
        public override void AddGumpLayout()
        {
            ...
            AddHtmlLocalized(10, 12, 520, 20, 1079588, LabelColor, false, false); //IMBUING MENU
            int yOffset = 0;
            ...
            // ===== Attribute Categories ========================================
            yOffset = 0;
            var menuCat = context.ImbMenuCat;

            switch (menuCat)
            {
	            // == CASTING ==
	            case 1 when itemRef is 1 or 2:
	            {
		            ...
		            if (Item is BaseWeapon weapon && (weapon.Attributes.SpellChanneling == 0 || weapon.Attributes.CastSpeed < 0))
		            {
	            ...
	            case 1 when itemRef == 3 || itemRef == 5:
	            ...
	            // == MISC ==
	            case 3 when itemRef == 1 || itemRef == 2:
		            ...
		            break;
	            case 3 when itemRef == 3 || itemRef == 5:
	            ...
	            case 4:
		            ...
		            break;
	            // == STATS ==
	            case 5 when itemRef == 3 || itemRef == 5:
                ...
                default:  // = Proceed to Attribute Intensity Menu [ImbuingC.cs]
                    {
                        ...
                        if (Item is BaseWeapon && id is >= 51 and <= 55)
                        {
                            id += 182;
                        }
                        ...
                        if (Imbuing.OnBeforeImbue(User, context.LastImbued, id))
                        {
