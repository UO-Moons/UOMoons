...
public class DefGlassblowing : CraftSystem
{
	...
	public static CraftSystem CraftSystem => _mCraftSystem ??= new DefGlassblowing();
	...
	public override int CanCraft(Mobile from, ITool tool, Type itemType)
	{
		...
		if (!(from is PlayerMobile {Glassblowing: true} mobile && mobile.Skills[SkillName.Alchemy].Base >= 100.0))
		{
			return 1044634; // You haven't learned glassblowing.
		}
