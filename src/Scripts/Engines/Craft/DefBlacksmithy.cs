...
public class DefBlacksmithy : CraftSystem
{
	...
	public static CraftSystem CraftSystem => _mCraftSystem ??= new DefBlacksmithy();
	...
	public static void CheckAnvilAndForge(Mobile from, int range, out bool anvil, out bool forge)
	{
		...
		foreach (Item item in eable)
		{
			...
			bool isAnvil = type.IsDefined(TypeofAnvil, false) || item.ItemId is 4015 or 4016 or 0x2DD5 or 0x2DD6;
			bool isForge = type.IsDefined(TypeofForge, false) || item.ItemId is 4017 or >= 6522 and <= 6569 or 0x2DD8;

			if (!isAnvil && !isForge) continue;
	...
	public override void PlayCraftEffect(Mobile from)
	{
		...
		if ( !Core.AOS && from.Body.Type == BodyType.Human && !from.Mounted )
	...
	public override int PlayEndingEffect(Mobile from, bool failed, bool lostMaterial, bool toolBroken, int quality, bool makersMark, CraftItem item)
	{
		...
		return quality == 2 ? 1044155 : 1044154;// You create an exceptional quality item.
	}
