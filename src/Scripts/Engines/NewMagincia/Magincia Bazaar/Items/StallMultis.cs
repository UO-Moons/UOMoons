...
{
	public List<Item> Fillers { get; private set; }

	public BaseBazaarMulti(int id) : base(id)
	{
		Fillers = new List<Item>();
	}
	...
	{
		foreach (var item in Fillers.Where(item => item is {Deleted: false}))
		{
