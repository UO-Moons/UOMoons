...
namespace Server.Engines.Doom
{
	public class LampRoomRegion : BaseRegion
	{
		...
		{
			if (m == null || m is WandererOfTheVoid || m.AccessLevel > AccessLevel.Player)
				return;
		...
		public override bool OnSkillUse(Mobile m, int Skill) => Controller.Successful != null && (m.AccessLevel != AccessLevel.Player || m == Controller.Successful);
	}
	...
	public class LeverPuzzleRegion : BaseRegion
	{
		...
		public Mobile Occupant => m_Occupant != null && m_Occupant.Alive ? m_Occupant : null;
