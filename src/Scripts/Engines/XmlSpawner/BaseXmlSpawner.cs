	...
	public class BaseXmlSpawner
	{
		...
		public static Item MagicArmor(int minLevel, int maxLevel, bool jewel, bool shield)
		{
			...
			else
			{
				...
				armor.Durability = (DurabilityLevel)BaseCreature.RandomMinMaxScaled(minLevel, maxLevel);
		...
		public static Item MagicWeapon(int minLevel, int maxLevel, bool jewel)
		{
			...
			else
			{
				...
				weapon.DurabilityLevel = (DurabilityLevel)BaseCreature.RandomMinMaxScaled(minLevel, maxLevel);
