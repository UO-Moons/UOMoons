...
namespace Server.Mobiles
{
	public class TalkingBaseEscortable : TalkingBaseCreature
	{
		...
		public static Hashtable EscortTable { get; } = new();
		...
		public virtual bool AcceptEscorter(Mobile m)
		{
			...
			TalkingBaseEscortable escortable = (TalkingBaseEscortable)EscortTable[m];
			...
			else if (SetControlMaster(m))
			{
				...
				if (m is PlayerMobile mobile1)
					mobile1.LastEscortTime = DateTime.Now;
