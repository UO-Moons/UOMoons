...
public class PartyCommandHandlers : PartyCommands
{
	...
	public override void OnSetCanLoot(Mobile from, bool canLoot)
	{
		...
		else
		{
			...
			{
				mi.CanLoot = canLoot;
				// You have chosen to allow your party to loot your corpse.// You have chosen to prevent your party from looting your corpse.
				from.SendLocalizedMessage(canLoot ? 1005447 : 1005448);
			}
		}
	}
