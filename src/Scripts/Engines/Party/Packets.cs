...
{
	public PartyEmptyList(IEntity m) : base(0xBF)
	{
		EnsureCapacity(7);
...
{
	public PartyRemoveMember(IEntity removed, Party p) : base(0xBF)
	{
...
{
	public PartyTextMessage(bool toAll, IEntity from, string text) : base(0xBF)
	{
		text ??= "";
...
{
	public PartyInvitation(IEntity leader) : base(0xBF)
	{
		EnsureCapacity(10);
