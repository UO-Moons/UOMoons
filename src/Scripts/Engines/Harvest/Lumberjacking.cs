...
{
	private static Lumberjacking _mSystem;

	public static Lumberjacking System => _mSystem ??= new Lumberjacking();
	...
	public override bool CheckHarvest(Mobile from, Item tool)
	{
		...
		if (tool.Parent == from) return true;
	...
	{
		Array.Sort(MTreeTiles);
	}

	#region Tile lists
	private static readonly int[] MTreeTiles = {
