...
public sealed class IngenuityQuest : BaseQuest
{
...
public sealed class HeaveHoQuest : BaseQuest
{
	public HeaveHoQuest()
	{
...
public sealed class ResponsibilityQuest : BaseQuest
{
...
public sealed class AllSeasonAdventurerQuest : BaseQuest
{
