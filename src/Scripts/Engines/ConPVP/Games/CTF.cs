...
public sealed class CTFTeamInfo : IRankedCTF
{
	...
	string IRankedCTF.Name => string.Format("{0} Team", Name);
...
public sealed class CTFController : EventController
{
	...
	[CommandProperty(AccessLevel.GameMaster)]
	public CTFTeamInfo Team1 { get => TeamInfo[0]; set { } }

	[CommandProperty(AccessLevel.GameMaster)]
	public CTFTeamInfo Team2 { get => TeamInfo[1]; set { } }

	[CommandProperty(AccessLevel.GameMaster)]
	public CTFTeamInfo Team3 { get => TeamInfo[2]; set { } }

	[CommandProperty(AccessLevel.GameMaster)]
	public CTFTeamInfo Team4 { get => TeamInfo[3]; set { } }

	[CommandProperty(AccessLevel.GameMaster)]
	public CTFTeamInfo Team5 { get => TeamInfo[4]; set { } }

	[CommandProperty(AccessLevel.GameMaster)]
	public CTFTeamInfo Team6 { get => TeamInfo[5]; set { } }

	[CommandProperty(AccessLevel.GameMaster)]
	public CTFTeamInfo Team7 { get => TeamInfo[6]; set { } }

	[CommandProperty(AccessLevel.GameMaster)]
	public CTFTeamInfo Team8 { get => TeamInfo[7]; set { } }
...
public sealed class CTFGame : EventGame
{
	...
	{
		if (m_Context._Tournament != null)
			m_Context._Tournament.Alert(text);
	...
	private void DelayBounce_Callback(object state)
	{
		...
		DuelContext.Refresh(mob, corpse);
	...
	private void Finish_Callback()
	{
		...
		Tournament tourny = m_Context._Tournament;
