...
public class FruitBasket : Food
{
	...
	public override bool Eat(Mobile from)
	{
		...
		from.AddToBackpack(new RoundBasket());
		return true;
	}
...
public class Banana : Food
{
	...
	[Constructable]
	private Banana(int amount) : base(amount, 0x171f)
	{
		Weight = 1.0;
		FillFactor = 1;
	}
...
public class Bananas : Food
{
	...
	[Constructable]
	private Bananas(int amount) : base(amount, 0x1721)
	{
		Weight = 1.0;
		FillFactor = 1;
	}
...
public class SplitCoconut : Food
{
	...
	[Constructable]
	private SplitCoconut(int amount) : base(amount, 0x1725)
	{
		Weight = 1.0;
		FillFactor = 1;
	}
...
public class Lemon : Food
{
	...
	[Constructable]
	private Lemon(int amount) : base(amount, 0x1728)
	{
		Weight = 1.0;
		FillFactor = 1;
	}
...
public class Lemons : Food
{
	...
	[Constructable]
	private Lemons(int amount) : base(amount, 0x1729)
	{
		Weight = 1.0;
		FillFactor = 1;
	}
...
public class Lime : Food
{
	...
	[Constructable]
	private Lime(int amount) : base(amount, 0x172a)
	{
		Weight = 1.0;
		FillFactor = 1;
	}
...
public class Limes : Food
{
	...
	[Constructable]
	private Limes(int amount) : base(amount, 0x172B)
	{
		Weight = 1.0;
		FillFactor = 1;
	}
...
public class Coconut : Food
{
	...
	[Constructable]
	private Coconut(int amount) : base(amount, 0x1726)
	{
		Weight = 1.0;
		FillFactor = 1;
	}
...
public class OpenCoconut : Food
{
	...
	[Constructable]
	private OpenCoconut(int amount) : base(amount, 0x1723)
	{
		Weight = 1.0;
		FillFactor = 1;
	}
...
public class Dates : Food
{
	...
	[Constructable]
	private Dates(int amount) : base(amount, 0x1727)
	{
		Weight = 1.0;
		FillFactor = 1;
	}
...
public class Grapes : Food
{
	...
	[Constructable]
	private Grapes(int amount) : base(amount, 0x9D1)
	{
		Weight = 1.0;
		FillFactor = 1;
	}
...
public class Peach : Food
{
	...
	[Constructable]
	private Peach(int amount) : base(amount, 0x9D2)
	{
		Weight = 1.0;
		FillFactor = 1;
	}
...
public class Pear : Food
{
	...
	[Constructable]
	private Pear(int amount) : base(amount, 0x994)
	{
		Weight = 1.0;
		FillFactor = 1;
	}
...
public class Apple : Food
{
	...
	[Constructable]
	private Apple(int amount) : base(amount, 0x9D0)
	{
		Weight = 1.0;
		FillFactor = 1;
	}
...
public class Watermelon : Food
{
	...
	[Constructable]
	private Watermelon(int amount) : base(amount, 0xC5C)
	{
		Weight = 5.0;
		FillFactor = 5;
	}
...
public class SmallWatermelon : Food
{
	...
	[Constructable]
	private SmallWatermelon(int amount) : base(amount, 0xC5D)
	{
		Weight = 5.0;
		FillFactor = 5;
	}
...
public class Squash : Food
{
	...
	[Constructable]
	private Squash(int amount) : base(amount, 0xc72)
	{
		Weight = 1.0;
		FillFactor = 1;
	}
...
public class Cantaloupe : Food
{
	...
	[Constructable]
	private Cantaloupe(int amount) : base(amount, 0xc79)
	{
		Weight = 1.0;
		FillFactor = 1;
	}
