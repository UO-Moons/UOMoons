...
public class Cabbage : Food
{
	...
	[Constructable]
	private Cabbage(int amount) : base(amount, 0xc7b)
	{
		Weight = 1.0;
		FillFactor = 1;
	}
...
public class Onion : Food
{
	...
	[Constructable]
	private Onion(int amount) : base(amount, 0xc6d)
	{
		Weight = 1.0;
		FillFactor = 1;
	}
...
public class Lettuce : Food
{
	...
	[Constructable]
	private Lettuce(int amount) : base(amount, 0xc70)
	{
		Weight = 1.0;
		FillFactor = 1;
	}
...
public class Pumpkin : Food
{
	...
	[Constructable]
	private Pumpkin(int amount) : base(amount, 0xC6A)
	{
		Weight = 1.0;
		FillFactor = 8;
	}
...
public class SmallPumpkin : Food
{
	...
	[Constructable]
	private SmallPumpkin(int amount) : base(amount, 0xC6C)
	{
		Weight = 1.0;
		FillFactor = 8;
	}
