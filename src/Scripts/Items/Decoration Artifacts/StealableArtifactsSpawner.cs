...
public class StealableArtifactsSpawner : BaseItem
{
	...
	private static StealableEntry[] Entries { get; } = {
	...
	public static IEnumerable<Type> TypesOfEntires
	{
		get
		{
	...
	private static StealableArtifactsSpawner Instance { get; set; }
	...
	public class StealableInstance
	{
		...
		private StealableEntry Entry { get; }
		...
		public DateTime NextRespawn { get; private set; }
