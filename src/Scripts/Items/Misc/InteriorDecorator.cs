	...
	private class InternalTarget : Target
	{
		...
		protected override void OnTarget(Mobile from, object targeted)
		{
			if (targeted is Item item && CheckUse(m_Decorator, from))
			{
				...
				if (item is AddonComponent or AddonContainerComponent or BaseAddonContainer)
				{
					object addon = null;
					int count = 0;
					...
					switch (item)
					{
						case AddonComponent addonComponent:
							count = addonComponent.Addon.Components.Count;
						...
						case BaseAddonContainer addonContainer:
						{
							count = addonContainer.Components.Count;
		...
		private static void Turn(Item item, Mobile from)
		{
			if (item is AddonComponent or AddonContainerComponent or BaseAddonContainer)
			{
				object addon = item switch
				{
					AddonComponent component => component.Addon,
					AddonContainerComponent component => component.Addon,
					_ => item
				};
