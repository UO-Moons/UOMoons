...
namespace Server.Items
{
    ...
    public class RunedSashOfWarding : BodySash
    {
        ...
        private static readonly Dictionary<Mobile, WardingEffect> m_Table = new();
        ...
        private int Charges {
	        init { m_Charges = value; InvalidateProperties(); } }

        [CommandProperty(AccessLevel.GameMaster)]
        private WardingEffect Ward { get; set; }
        ...
        public RunedSashOfWarding()
        {
            ...
            Ward = Utility.RandomBool() ? WardingEffect.WeaponDamage : WardingEffect.SpellDamage;
        ...
        public override void OnDoubleClick(Mobile from)
        {
            ...
            else if (from.FindItemOnLayer(Layer.MiddleTorso) == this)
            {
                ...
                BuffInfo.AddBuff(from, new BuffInfo(BuffIcon.Warding, 1151395, 1151396, Ward == WardingEffect.WeaponDamage ? 1116172 : 1116173));
            }
            else
            {
        ...
        private static void RemoveEffects(object obj)
        {
        ...
        public override void Deserialize(GenericReader reader)
        {
            ...
            Ward = (WardingEffect)reader.ReadInt();
        }
    }
