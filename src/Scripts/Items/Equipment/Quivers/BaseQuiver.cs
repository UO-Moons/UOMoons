...
namespace Server.Items
{
    ...
    public class BaseQuiver : Container, ISetItem, IRangeDamage, IArtifact
    {
        ...
        {
            typeof(Arrow), typeof(CrossBowBolt)
        };
        ...
        public class RefillQuiverEntry : ContextMenuEntry
        {
            ...
            public override void OnClick()
            {
                ...
                {
                    if (m_quiver.IsArrowAmmo ? Refill<Arrow>(m, m.BankBox) : Refill<CrossBowBolt>(m, m.BankBox))
                        return;
                }
                ...
                foreach (Item i in items)
                {
                    ...
                    if (m_quiver.IsArrowAmmo ? Refill<Arrow>(m, c) : Refill<CrossBowBolt>(m, c))
                        return;
                }
