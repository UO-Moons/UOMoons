...
public class Ankhs
{
	private const int ResurrectRange = 2;
	private const int TitheRange = 2;
	private const int LockRange = 2;
	...
	private class LockKarmaEntry : ContextMenuEntry
	{
		...
		public override void OnClick()
		{
			...
			m_Mobile.SendLocalizedMessage(m_Mobile.KarmaLocked ? 1060192 : 1060191);
		}
	}
