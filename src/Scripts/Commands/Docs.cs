...
public class Docs
{
	...
	[Usage("DocGen")]
	[Description("Generates UOMoons documentation.")]
	...
	private class MemberComparer : IComparer
	{
		public int Compare(object x, object y)
		{
			...
			switch (aStatic)
			{
				case true when !bStatic:
					return -1;
				case false when bStatic:
					return 1;
			}
			...
			if (v == 0)
			{
				v = string.Compare(GetNameFrom(aCtor, aProp, aMethod), GetNameFrom(bCtor, bProp, bMethod), StringComparison.Ordinal);
			}
